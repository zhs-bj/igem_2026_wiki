...
- 实现首页推开窗进入花园的 GSAP 动画，比较初始，还需调整
- 完成五种糖基花朵 SVG（菱形/圆形/三角形/方形/圆形），但是画得不够像，后续还需调整
- 自定义顶部导航栏（Project / Technology / Community / Team 四级下拉），但还没完成超链接的跳转
- 生成 28 个内容页面骨架，内容还未填写
- 配置 PWA 与本地搜索，但内部还未搭建起来
